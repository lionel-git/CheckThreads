...
public:
    ...
    module_data operator()(HMODULE module) {
        ...
        std::vector<wchar_t> img(ret.image_name.begin(), ret.image_name.end());
        std::vector<wchar_t> mod(ret.module_name.begin(), ret.module_name.end());
...
DWORD DumpStackTrace(EXCEPTION_POINTERS* ep)
{
    ...
    if (!SymInitialize(process, "toto", false)) // Path
